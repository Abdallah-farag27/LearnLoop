...
router.route("/")
  ...
  .post(Auth.HasPersmissions,uploadImage.single("pro_img"),projectController.createProject);

router.route("/:projectId")
  .get(projectController.getProjectById)
  .delete(Auth.HasPersmissions, projectController.deleteProject)
  .patch(Auth.HasPersmissions,uploadImage.single("pro_img"),projectController.updateProject);
